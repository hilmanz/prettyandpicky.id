              ...
              <ul>
                ...
                <li>
                  <form role="search" method="get" id="searchform" class="searchform" action="<?php echo home_url();?>">
                      <input type="text" value="" name="s" id="s" class="form-control form-input-search" style="display: none">
                      <a href="javascript:void(0)" id="btn-open-search"><i class="fa fa-search"></i></a>
                  </form>
                </li>
              </ul>
            </div>
